<html>  
 ...
 $namaError = "nama tidak boleh
kosong";
 }if(empty(trim($_POST['nim']))){
 $nimError = "nim tidak boleh
kosong";
 }if(empty(trim($_POST['gender']))){
 $genderError = "jenis kelamin tidak
boleh kosong";
 }}
 ?>
...
:</label><span class="error"> * <?php echo
$genderError;?></span><br>
 <input type="radio" name="gender"
id="laki" value="Laki-laki"<?php if
(isset($_POST["gender"]) and $_POST["gender"] ==
"Laki-laki") echo "checked";?>>Laki-laki <br>
 <input type="radio" name="gender"
id="perempuan" value="Perempuan" <?php if
(isset($_POST["gender"]) and $_POST["gender"] ==
